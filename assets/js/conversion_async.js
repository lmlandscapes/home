(function() {
    ...
    */
    ...
    function Kb(a, b) {
        ...
        "port" === c ? a.port = String(Number(a.hostname ? a.port : H.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === c && (a.hostname = (a.hostname || H.location.hostname).replace(Ib, "").toLowerCase());
        var d = Lb(a.protocol);
    ...
    function oc(a, b, c) {
        if (jc.test(a.location.host))
            return (b = a.location.href.match(c)) && 2 == b.length && b[1].match(hc) ? decodeURIComponent(b[1]) : "";
        a = [];
        for (var d in b) {
            c = [];
    ...
    function tc(a, b) {
        var c = "" !== sc(a, b) || 0 < x(Object, "keys").call(Object, Q() ? P("_gac_gb", !0) : {}).length;
    ...
    function Dc() {
        var a = K(yc);
        return x(Object, "values").call(Object, xc).map(function(b) {
            return [b, a.g[b] || 0]
        })
    }
    ;
    ...
    function Uc(a, b) {
        ...
        if (Wc(b) && b.l)
            ...
            jc.test(a.location.host) ? f = !(mc.test(a.location.href) || kc.test(a.location.href)) : (f = Math.max(fc("aw", d), gc(Q() ? P() : {})), f = Math.max(fc("gb", d), gc(Q() ? P("_gac_gb", !0) : {})) > f);
        if (f) {
            if (void 0 !== b.m)
                return b.m;
            c = sc(a, d || void 0);
    ...
    function Yc(a, b, c, d, e, f) {
        ...
        if (a) {
            var G = a.screen;
            G && (u.push(T("u_h", G.height)), u.push(T("u_w", G.width)), u.push(T("u_ah", G.availHeight)), u.push(T("u_aw", G.availWidth)), u.push(T("u_cd", G.colorDepth)));
            a.history && u.push(T("u_his", a.history.length))
        }
        X && "function" == typeof X.getTimezoneOffset && u.push(T("u_tz", -X.getTimezoneOffset()));
        b && ("function" == typeof b.javaEnabled && u.push(T("u_java", b.javaEnabled())),
        b.plugins && u.push(T("u_nplug", b.plugins.length)), b.mimeTypes && u.push(T("u_nmime", b.mimeTypes.length)));
        X = u.join("");
        ...
        if (c) {
            if (a.top == a)
                ...
                if (J)
                    r = J[J.length - 1] == a.location.origin ? 1 : 2;
                else {
                    J = a.top;
                    try {
                        var z;
        ...
        a = [h, k, m, n, p, q, t, C, W, gd, hd, id, jd, kd, w, ld, md, nd, od, X, u, b, G, qd, f, ua, va, Xc(c), $c(d.google_additional_params), $c(d.google_remarketing_only ? {} : d.google_additional_conversion_params),
        "&hn=" + S("www.googleadservices.com"), ad(a)].join("");
        c = Za();
            ...
            if (d)
                if (r = d.google_conversion_items) {
                    ...
                    for (k = r.length; h < k; h++)
                        m = r[h],
                        n = [],
                        m && (n.push(U(m.value)), n.push(U(m.quantity)), n.push(U(m.item_id)),
    ...
    function ed(a, b) {
        F && "376635471" == ab(2) && ("complete" === b.readyState ? bd(b) : a.addEventListener ? a.addEventListener("load", function() {
            bd(b)
    ...
    function ad(a) {
        if (!Xa || !a.__gsaExp || !a.__gsaExp.id)
            return "";
        a = a.__gsaExp.id;
        if (!eb(a))
            return "";
    ...
    function vd(a, b) {
        ...
        if (!b || !b.capi)
            return !1;
        if (!(b = Oc))
            if (b = x("www.googleadservices.com", "endsWith").call("www.googleadservices.com", "google.com") ? "" : "", a = void 0 === a ? window.document : a, b && a.head) {
                var c = Pa("META");
    ...
    function yd(a, b, c) {
        try {
            if (!wd && (wd = !0, !c.google_gtm)) {
                ...
                var f;
                if (f = !d)
                    f = 0 <= na(b.cookie.split("; "), "__TAG_ASSISTANT=x");
                f && (d = 4);
                if (!d) {
    ...
    function Bd(a, b, c, d) {
        ...
        try {
            if (fd(d)) {
                d.google_remarketing_only && d.google_enable_display_cookie_match && !Kc && F && $a(["376635470", "376635471"], Qa, 2);
                d.google_remarketing_only && !d.google_conversion_domain && F && $a(["759238990", "759238991"], Ta, 13);
                !d.google_remarketing_only || d.google_conversion_domain || F && ("759248991" == ab(14) || "759248990" == ab(14)) || F && $a(["759248990", "759248991"], Sa, 14);
                ...
                if (1 == d.google_remarketing_only && null != d.google_gtag_event_data && null != d.google_gtag_event_data.items && d.google_gtag_event_data.items.constructor === Array && 0 < d.google_gtag_event_data.items.length)
                    ...
                    if (d.google_conversion_domain || d.google_transport_url && "https://pagead2.googlesyndication.com/" !== d.google_transport_url)
                        f = !1;
                    var g = !1;
                    x("www.googleadservices.com", "endsWith").call("www.googleadservices.com",
                    "google.com") && (g = !0);
    ...
    for (var Z; V.length && (Z = V.shift());)
        V.length || void 0 === Dd ? Y[Z] && Y[Z] !== Object.prototype[Z] ? Y = Y[Z] : Y = Y[Z] = {} : Y[Z] = Dd;
